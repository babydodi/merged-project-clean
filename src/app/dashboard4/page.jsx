...
export default function Dashboard() {
  ...
  const studentData = useMemo(() => {
    ...
    // Weekly progress (simple: first 7 results)
    // التقدّم الأسبوعي (بسيط: أول 7 نتائج)
      ...
      >
        <div className="p-6">
          ...
          <nav className="space-y-2">
            {[
              { icon: Home, label: 'Dashboard / لوحة التحكم', active: true },
              { icon: BookOpen, label: 'My Tests / اختباراتى', active: false },
              { icon: BarChart3, label: 'Analytics / تحليلات', active: false },
              { icon: Calendar, label: 'Schedule / الجدول', active: false },
              { icon: Settings, label: 'Settings / الإعدادات', active: false },
            ].map((item, index) => (
              <motion.button
                key={item.label}
      ...
      <div className={`transition-all duration-300 ${sidebarOpen ? 'lg:ml-64' : 'ml-0'}`}>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            {/* Weekly Progress / التقدّم الأسبوعي */}
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.4 }}
            >
              <Card className="bg-[#141414] border-[#2a2a2a]">
                <CardHeader>
                  <CardTitle className="text-xl text-white">Weekly Progress / تقدم الأسبوع</CardTitle>
                  <CardDescription className="text-gray-400">Your performance this week / أداؤك هذا الأسبوع</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  {studentData.weeklyProgress.length === 0 ? (
                    <div className="text-gray-400">No progress data yet. / لا توجد بيانات تقدم بعد.</div>
                  ) : (
          ...
          >
            <Card className="bg-[#141414] border-[#2a2a2a] hover:border-[#3a3a3a] transition-all cursor-pointer group">
              <CardHeader>
                ...
                <CardTitle className="text-lg text-white">Set Goals / تعيين أهداف</CardTitle>
                <CardDescription className="text-gray-400">Define your study targets / حدد أهداف دراستك</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-[#141414] border-[#2a2a2a] hover:border-[#3a3a3a] transition-all cursor-pointer group">
              <CardHeader>
                ...
                <CardTitle className="text-lg text-white">Achievements / الإنجازات</CardTitle>
                <CardDescription className="text-gray-400">View your badges & awards / اعرض الشارات والجوائز</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-[#141414] border-[#2a2a2a] hover:border-[#3a3a3a] transition-all cursor-pointer group">
              <CardHeader>
                ...
                <CardTitle className="text-lg text-white">Study Plan / خطة الدراسة</CardTitle>
                <CardDescription className="text-gray-400">Get personalized recommendations / احصل على توصيات مخصصة</CardDescription>
              </CardHeader>
            </Card>
          </motion.div>
          ...
          >
            <Card className="bg-[#141414] border-[#2a2a2a]">
              <CardHeader>
                <CardTitle className="text-xl text-white">Strengths / نقاط القوة</CardTitle>
                <CardDescription className="text-gray-400">Your best performing areas / أهم المجالات التي تتفوق فيها</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="text-gray-400">No strengths data yet. / لا توجد بيانات لنقاط القوة بعد.</div>
              </CardContent>
            </Card>

            <Card className="bg-[#141414] border-[#2a2a2a]">
              <CardHeader>
                <CardTitle className="text-xl text-white">Areas to Improve / مجالات للتحسين</CardTitle>
                <CardDescription className="text-gray-400">Focus on these topics / ركز على هذه المواضيع</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="text-gray-400">No improvement data yet. / لا توجد بيانات للتحسين بعد.</div>
              </CardContent>
            </Card>
          </motion.div>
        </div>
