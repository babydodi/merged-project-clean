...
export default function Landing2() {
  ...
  // showPlansInDialog: when true show plans inside dialog (Form 2). when false show simple form (Form 1).
  ...
  // helper to open dialog in two modes
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // close dialog and redirect to dashboard; subscription handled in dashboard
    ...
    {/* Navigation */} <motion.nav initial={{ y: -100 }} animate={{ y: 0 }} transition={{ duration: 0.6, ease: 'easeOut' }} className="fixed top-0 w-full z-50 bg-[#0a0a0a]/80 backdrop-blur-lg border-b border-[#2a2a2a]" >
      ...
      <div className="container mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} >
          {/* Get Started: open simple form (no plans) */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            {/* Start Your Journey: open simple form (no plans) */}
                ...
                <CardFooter className="pt-6">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      // When clicking Get Started on pricing card: open dialog WITH plans and preselect plan
