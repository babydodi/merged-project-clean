    ...
    try {
      ...
      for (const ch of chaptersData || []) {
        if (ch.type === 'listening') {
          // safe select: do NOT request base_text/underlined_* from listening_questions (they don't exist)
          ...
          // if passage includes "1. ..." lines we parse them into passage_paragraphs for nicer rendering
