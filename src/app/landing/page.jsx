              ...
              >
                <Card
                  className={`relative overflow-hidden h-full ${
                    plan.popular ? 'bg-white border-white' : 'bg-[#141414] border-[#2a2a2a]'
                  }`}
                >
                  {plan.popular && (
                  ...
                  <CardFooter className="pt-6">
                    <Button
                      className={`w-full transition-all transform hover:scale-105 ${
                        plan.popular ? 'bg-black text-white hover:bg-gray-900' : 'bg-white text-black hover:bg-gray-200'
                      }`}
                      size="lg"
                      onClick={() => {
                ...
                {['basic', 'premium'].map((planType) => (
                  <button
                    ...
                    className={`flex-1 p-4 rounded-lg border-2 transition-all ${
                      formData.plan === planType ? 'border-white bg-white/10' : 'border-[#2a2a2a] hover:border-[#3a3a3a]'
                    }`}
                  >
